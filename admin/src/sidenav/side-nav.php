    ...
    <aside class="sidebar"> 
        ...
        <form action="../../src/sidenav/side-nav-route.php" method="POST" class="form">
            <div class="buttons-container">
                ...
                <button type='submit' name="action" value="schedules" class="<?php echo $_SESSION['action'] === 'schedules' ? 'active-button' : 'default-button'?>"><img class="<?php echo $_SESSION['action'] === 'schedules' ? 'active-icon' : 'default-icon'?>" src="../../assets/images/sidenav-icons/Schedule.svg" alt="Schedule icon">Schedules</button>
